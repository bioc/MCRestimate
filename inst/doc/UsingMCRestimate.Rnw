...
list.of.poss.parameter        <- list(var.numbers=c(10,25))
@
...
{\bf The Cross-validation parameter (see man page for details):} The values for  \Rfunarg{cross.outer} and \Rfunarg{cross.inner} should be at least 5.
